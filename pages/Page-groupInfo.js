    ...
    return(
        <View style={styles.gipageStructure}>
            ...
            <View style={styles.giSubHeader}>
                ...
                />
                <Text style={styles.giclosingtimeText}>Group closes in<Text style={styles.gispectimeText}> 100 </Text>hours</Text>
            ...
            <View style={styles.giTextSec}>
                <ScrollView>
                    ...
                    <Text style={styles.groupDescText}>
                        This is a group description for players who are looking  at other created groups cards. So you can only view no editing.
                    </Text>
                    ...
                    <View style={{flexDirection:'row'}}>
                        ...
                        <Text style={styles.giText}>4351 No 3 Rd #100,{"\n"}Richmond, BC V6X 3A7</Text>
                    </View>
                    <View style={{flexDirection:'row'}}>
